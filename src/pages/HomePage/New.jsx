export default function New() {
    return (
        <div>
            <div className="w-full flex flex-col justify-center items-center min-h-[80vh] sm:min-h-[90vh] md:min-h-screen bg-cover bg-center bg-no-repeat bg-[url(/bg.jpg)] relative px-4">
                ...
                <div className="flex flex-col justify-center items-center relative gap-6 sm:gap-8 md:gap-10">
                    ...
                    <img className="w-full max-w-6xl h-[24vh] sm:h-[28vh] md:h-[34vh] lg:h-[40vh] relative top-4 left-0 object-contain" src="/naxs.svg" alt="" />
                </div>
            </div>
        </div>
    )
